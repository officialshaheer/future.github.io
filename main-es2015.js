...
module.exports = __webpack_require__(/*! /Users/shaheershahabudeen/Software Experiments/portfolio/src/main.ts */"zUnb");
...
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], decls: 15, vars: 0, consts: [[2, "padding-bottom", "30px"], [1, "card-views"], [1, "card-comments"]], template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! smooth-scrollbar */ "V0Rq");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _services_socket_socket_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/socket/socket-service.service */ "cZ7/");
...
class AppComponent {
    constructor(document, socketService) {
    ...
    ngAfterViewInit() {
        const scrollbar = smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__["default"].init(document.querySelector('#smooth-scrollbar'));
        scrollbar.options.damping = 0.1;
        scrollbar.options.renderByPixels = false;
    }
}
AppComponent.ɵfac = function AppComponent_Factory(t) { return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_0__["DOCUMENT"]), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_services_socket_socket_service_service__WEBPACK_IMPORTED_MODULE_3__["SocketServiceService"])); };
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_4__["NavbarComponent"], _portfolio_portfolio_component__WEBPACK_IMPORTED_MODULE_5__["PortfolioComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAuY29tcG9uZW50LmNzcyJ9 */"] });
...
class SocketServiceService {
    ...
    constructor() {
        this.socket = Object(socket_io_client__WEBPACK_IMPORTED_MODULE_1__["io"])('ws://localhost:3000', { transports: ['websocket'] });
    }
    listen(eventName) {
...
SocketServiceService.ɵfac = function SocketServiceService_Factory(t) { return new (t || SocketServiceService)(); };
SocketServiceService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ token: SocketServiceService, factory: SocketServiceService.ɵfac, providedIn: 'root' });
...
class NavbarComponent {
    constructor() {
        this.ustAnimation = [{ a: 'U', b: 'S', c: 'T', d: '.' }];
        this.ust = 'UST.';
    }
    ngOnInit() {
        this.animateUSTLogo();
...
NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavbarComponent, selectors: [["app-navbar"]], decls: 17, vars: 4, consts: [["role", "navigationBar", 1, "navigation-bar"], [1, "spacer"], [2, "font-weight", "bolder"]], template: function NavbarComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var three_examples_jsm_loaders_DRACOLoader_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! three/examples/jsm/loaders/DRACOLoader.js */ "DKVj");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _services_socket_socket_service_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/socket/socket-service.service */ "cZ7/");
...
class PortfolioComponent {
    ...
    ngOnInit() {
        ...
        this.socketService.emit('send message', 'Hello every body');
        // Server sending back all the user existence
        this.socketService.listen('sendtoall').subscribe((data) => {
            // playJoiningSound();
        });
        ...
        const fog = new three__WEBPACK_IMPORTED_MODULE_0__["Fog"]('#262837', 1, 15);
        // scene.fog = fog
        // Sounds
        ...
        fontLoader.load('assets/fonts/helvetiker_regular.typeface.json', (font) => {
            const textGeometry = new three__WEBPACK_IMPORTED_MODULE_0__["TextBufferGeometry"]('UST', {
                font: font,
                size: .5,
                height: 0.05,
                curveSegments: 12,
            ...
            textGeometry.center();
            const textMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshBasicMaterial"]({
                color: 0xffffff
            });
            const text = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](textGeometry, textMaterial);
        ...
        const camera = new three__WEBPACK_IMPORTED_MODULE_0__["PerspectiveCamera"](75, sizes.width / sizes.height, 0.1, 10000);
        camera.position.x = 0;
        camera.position.y = 5;
...
PortfolioComponent.ɵfac = function PortfolioComponent_Factory(t) { return new (t || PortfolioComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_services_socket_socket_service_service__WEBPACK_IMPORTED_MODULE_5__["SocketServiceService"])); };
PortfolioComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: PortfolioComponent, selectors: [["app-portfolio"]], decls: 0, vars: 0, template: function PortfolioComponent_Template(rf, ctx) { }, styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwb3J0Zm9saW8uY29tcG9uZW50LmNzcyJ9 */"] });
